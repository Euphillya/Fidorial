...
public interface ArgumentTypeIds {
    ...
    Map<Key, Integer> BY_IDENTIFIER = Map.ofEntries(
            ...
            Map.entry(Key.key("minecraft:angle"), ANGLE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:block_pos"), BLOCK_POS_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:block_predicate"), BLOCK_PREDICATE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:block_state"), BLOCK_STATE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:column_pos"), COLUMN_POS_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:component"), COMPONENT_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:dialog"), DIALOG_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:dimension"), DIMENSION_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:entity"), ENTITY_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:entity_anchor"), ENTITY_ANCHOR_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:float_range"), FLOAT_RANGE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:function"), FUNCTION_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:game_profile"), GAME_PROFILE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:gamemode"), GAMEMODE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:heightmap"), HEIGHTMAP_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:hex_color"), HEX_COLOR_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:int_range"), INT_RANGE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:item_predicate"), ITEM_PREDICATE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:item_slot"), ITEM_SLOT_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:item_slots"), ITEM_SLOTS_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:item_stack"), ITEM_STACK_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:loot_modifier"), LOOT_MODIFIER_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:loot_predicate"), LOOT_PREDICATE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:loot_table"), LOOT_TABLE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:message"), MESSAGE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:nbt_compound_tag"), NBT_COMPOUND_TAG_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:nbt_path"), NBT_PATH_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:nbt_tag"), NBT_TAG_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:objective"), OBJECTIVE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:objective_criteria"), OBJECTIVE_CRITERIA_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:operation"), OPERATION_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:particle"), PARTICLE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:resource"), RESOURCE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:resource_key"), RESOURCE_KEY_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:resource_location"), RESOURCE_LOCATION_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:resource_or_tag"), RESOURCE_OR_TAG_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:resource_or_tag_key"), RESOURCE_OR_TAG_KEY_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:resource_selector"), RESOURCE_SELECTOR_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:rotation"), ROTATION_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:score_holder"), SCORE_HOLDER_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:scoreboard_slot"), SCOREBOARD_SLOT_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:style"), STYLE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:swizzle"), SWIZZLE_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:team"), TEAM_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:team_color"), TEAM_COLOR_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:template_mirror"), TEMPLATE_MIRROR_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:template_rotation"), TEMPLATE_ROTATION_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:time"), TIME_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:uuid"), UUID_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:vec2"), VEC2_ARGUMENT_ID),
            Map.entry(Key.key("minecraft:vec3"), VEC3_ARGUMENT_ID)
    );
