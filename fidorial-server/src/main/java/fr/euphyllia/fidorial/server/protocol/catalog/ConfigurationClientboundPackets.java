...
public final class ConfigurationClientboundPackets {
    ...
    public static final String FINISH_CONFIGURATION = "minecraft:finish_configuration";
    public static final String KEEP_ALIVE = "minecraft:keep_alive";
    public static final String PING = "minecraft:ping";
    public static final String RESET_CHAT = "minecraft:reset_chat";
    public static final String REGISTRY_DATA = "minecraft:registry_data";
    ...
    public static final String UPDATE_ENABLED_FEATURES = "minecraft:update_enabled_features";
